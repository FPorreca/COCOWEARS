...
public:
	...
	SSD1306(u16 IIC_DEVICE_ID, u16 SCLK_RATE, u8 IIC_ADDR);

private:
	void SendByteCommand(uint8_t cmd);
	void Send2ByteCommand(uint8_t cmd, uint8_t val);
	void Send3ByteCommand(uint8_t cmd, uint8_t val_1, uint8_t val_2);
	void Send4ByteCommand(uint8_t cmd, uint8_t val_1, uint8_t val_2, uint8_t val_3);
	void Send5ByteCommand(uint8_t cmd, uint8_t val_1, uint8_t val_2, uint8_t val_3, uint8_t val_4);
	void Send6ByteCommand(uint8_t cmd, uint8_t val_1, uint8_t val_2, uint8_t val_3, uint8_t val_4, uint8_t val_5);
	void SendClearCommand();
	void SendByteData(uint8_t val);
